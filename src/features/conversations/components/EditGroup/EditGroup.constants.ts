export const EDIT_GROUP_OPEN_LABEL = 'Group settings'
export const EDIT_GROUP_TITLE = 'Group settings'

export const EDIT_GROUP_NAME_LABEL = 'Name'
export const EDIT_GROUP_NAME_PLACEHOLDER = 'Group name'
export const EDIT_GROUP_NAME_SAVE_LABEL = 'Save name'
export const EDIT_GROUP_NAME_SAVING_LABEL = 'Saving…'

export const EDIT_GROUP_PHOTO_LABEL = 'Photo'
export const EDIT_GROUP_UPLOAD_LABEL = 'Upload photo'
export const EDIT_GROUP_REPLACE_LABEL = 'Replace photo'
export const EDIT_GROUP_REMOVE_LABEL = 'Remove'

export const EDIT_GROUP_AVATAR_ACCEPT = 'image/png,image/jpeg,image/webp'
// Mirrors the backend's group avatar limit — checked client-side for fast feedback.
export const EDIT_GROUP_AVATAR_MAX_BYTES = 5 * 1024 * 1024

export const EDIT_GROUP_NAME_SAVED_TOAST = 'Group name updated'
export const EDIT_GROUP_AVATAR_SAVED_TOAST = 'Group photo updated'
export const EDIT_GROUP_AVATAR_REMOVED_TOAST = 'Group photo removed'
export const EDIT_GROUP_AVATAR_TOO_LARGE = 'Image must be under 5 MB'
