...
import type { ConversationItemContextValue } from '../context/ConversationItem.context'
...
const defaultContext: ConversationItemContextValue = {
  ...
  unreadCount:        0,
  isSelected:         false,
  pinButtonClass:     'pin-idle',
  pinButtonLabel:     'Pin',
  pinButtonAriaLabel: 'Pin conversation',
  onPinClick:         vi.fn(),
  onSelect:           vi.fn(),
}
...
function renderWithContext(overrides: Partial<ConversationItemContextValue> = {}) {
  ...
  return render(
    <ConversationItemProvider value={value}>
